...
import { PDB, PDBLoader } from 'three-platformize/examples/jsm/loaders/PDBLoader';
import { TrackballControls } from 'three-platformize/examples/jsm/controls/TrackballControls';
import {
  BoxBufferGeometry,
  Color,
  Group,
...
export class DemoPDBLoader extends Demo {
  ...
  async init(): Promise<void> {
    ...
    const pdb = await loader.loadAsync(baseUrl + '/models/molecules/caffeine.pdb');
